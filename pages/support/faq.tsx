  ...
  const faqList = [
    {
      ...
      answer:
        '온라인 연수 공식 홈페이지(www.okfyouthcamp.com) 접속, 회원가입을 통해 참여가 가 능합니다.\n[연수 신청기간]\n2022. 05. 12(목) ~ 2022. 06. 30(목) (KST 기준) * 상황에 따라 조기 마감될 수 있음',
    },
    {
      id: 1,
    ...
    },
    {
      ...
      answer:
        '이수 가능합니다. 실시간으로 참여하지 않더라도, 이후 실시간으로 진행된 콘텐츠의 녹화 본을 이수하여 이수가 가능합니다.\n**단 마일리지 적립에서의 차이가 있습니다(라이브 이수시 10point, 녹화본 이수시 5point 적 립)',
    },
    {
      id: 6,
      question: '온라인 연수 프로그램 시청 시 필수 확인 사항은 무엇이 있나요?',
      answer:
        '[필수 차시] 모든 프로그램은 일시 개방되어 필수 차시 내 모든 프로그램을 이수하여야 이수 증 발급이 가능합니다.\n[선택 차시] 모든 프로그램은 일시 개방되어 참가자 스스로 선택하여 프로그램을 학습 할 수 있습니다.\n[만족도 조사] 강의 시청 종료 후 강의만족도 조사를 완료해주셔야 해당 강의가 정상적으로 이수 처리됩니다.',
    },
    {
      id: 7,
      question:
    ...
    },
    {
      ...
      answer:
        '연수 기간 내 적립된 마일리지 점수를 기준으로 각 회기 별 우수참가자를 선발하여 다양 한 혜택을 제공하고 있습니다.\n\n[재외동포대학생 대상]\n2023년 오프라인 연수 참가 시\n1) 이수자 상위 5% 대상 : 차년도 오프라인 참가시 항공료 추가 5% 지원 및 차년도 오프라 인 참가시 우선 선발\n2) 이수자 상위 30% 대상 : 차년도 오프라인 참가시 우선 선발\n3) 이수자 전원 : 차년도 오프라인 참가시 가점 부여\n\n[국내대학생 대상]\n1) 이수자 상위 50명 : 연수종료시 통일공공외교캠프 참여 기회 제공\n2) 이외 이수자 : 이벤트를 통한 기프티콘 혹은 전자상품권 지급',
    },
    {
      id: 10,
      question: 'PC로만 온라인연수에 참여할 수 있나요?',
      answer:
        '2022 재외동포대학생모국연수(온라인)은 PC, 모바일, 태블릿 등 다양한 전자기기를 활용하 여 참여할 수 있습니다!',
    },
    {
      id: 11,
      question: '온라인 연수 참가 시 어떤 브라우저를 사용해야하나요?',
      answer:
        '온라인 연수 참가 시 안정적인 인터넷 환경을 위해 유선 인터넷을 권장합니다. 와이파이 및 핫스팟을 연결하여 연수 참여 시 네트워크 통신이 원활하지 않을 수 있습니다.\n\n*파이어폭스로 접속이 되지 않을 시, Chrome 또는 최신 브라우저로, Chrome으로 접속이 되지 않을 시, 파이어폭스 또는 다른 최신 브라우저로 접속하여 주시기 바랍니다.',
    },
    {
      id: 12,
      question: '이수증은 어떻게 발급받을 수 있나요?',
      answer:
        '이수증은 필수차시 내 모든 프로그램 이수 후 ‘지원센터 → 이수증 발급’ 페이지를 통해 발급이 가능합니다. 단, 이수증은 정해진 기간내에만 발급이 가능하므로 참고 부탁드립니다.\n※ 이수증 발급 기간에 대해서는 추후 공지사항을 통해 안내될 예정입니다.',
    },
    {
      id: 13,
      question:
      ...
      answer:
        '홈페이지내 지원센터의 ‘1대1 문의하기’를 통해 문의주시면 친절히 답변 드리겠습니다.',
    },
  ];
