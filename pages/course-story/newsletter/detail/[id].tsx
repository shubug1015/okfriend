  ...
  return (
    <>
      ...
      <Layout bgColor='bg-[#f4f9fb]' padding='py-14'>
        <div className='font-bold'>뉴스레터</div>
      ...
      <Layout padding='py-20'>
        ...
        <div className='mt-12 flex justify-center'>
          <div
            ...
            className='flex h-16 w-40 cursor-pointer items-center justify-between rounded-lg bg-[#2fb6bc] px-3.5 transition-opacity hover:opacity-90'
          >
            <div className='flex space-x-2'>
              ...
              <div className='font-medium text-white'>좋아요</div>
            </div>

            <div className='text-white'>{data?.like_num}</div>
          </div>
        </div>

        <div className='mt-20 flex items-center space-x-4 border-b border-b-[#e8e8e8] pb-8'>
        ...
        <div className='flex items-center justify-between space-x-14 border-b border-b-[#e8e8e8]'>
          <div className='grow py-8'>
            <input
              ...
              className='mt-2 w-full px-7 text-lg outline-none placeholder:text-[#9e9e9e]'
            />
          ...
          <div
            ...
            className='flex h-[2.8rem] w-[7.5rem] cursor-pointer items-center justify-center space-x-1.5 rounded-lg bg-[#2fb6bc] font-medium text-white transition-all hover:opacity-90'
          >
            <svg
              width='24'
              height='24'
