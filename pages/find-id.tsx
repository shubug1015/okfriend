  ...
  return (
    <>
      ...
      <div className='mx-auto my-28 flex max-w-[43.75rem] flex-col items-center rounded-lg bg-white p-[3.75rem]'>
        <h1 className='text-3xl font-bold'>아이디 찾기</h1>
              ...
              <div
                ...
                className={cls(
                  watch('phoneNum') && !errors?.phoneNum?.message
                    ...
                    : '',
                  'ml-4 flex h-full w-[7.5rem] items-center justify-center rounded border border-[#2fb6bc] text-[#2fb6bc] font-medium text-sm'
                )}
              >
                {code.loading ? (
                  <svg
